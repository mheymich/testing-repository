...
Public Class FolderBrowserDialogForm
    Inherits Form
    ...
    Private WithEvents folderMenuItem As MenuItem,
                       closeMenuItem As MenuItem,
    ...
    Public Sub New()
        ...
        Me.fileMenuItem.MenuItems.AddRange(
    ...
    <STAThread()>
    Shared Sub Main()
        Application.Run(New FolderBrowserDialogForm())
    End Sub
